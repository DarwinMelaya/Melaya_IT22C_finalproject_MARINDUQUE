...
<body>
    <?php
    $xml = simplexml_load_file('Melaya_IT2C_Marinduque/guide.xml');
    ?>
    <!-- Topbar Start -->
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <div class="text-center mb-3 pb-3">
                <h6 class="text-primary text-uppercase" style="letter-spacing: 5px;"><?php echo $xml->content->guide; ?></h6>
                <h1><?php echo $xml->content->our; ?></h1>
            </div>
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-6 pb-2">
                    <div class="team-item bg-white mb-4">
                        ...
                        <div class="text-center py-4">
                            <h5 class="text-truncate"><?php echo $xml->content->name1; ?></h5>
                            <p class="m-0"><?php echo $xml->content->designation; ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 pb-2">
                    <div class="team-item bg-white mb-4">
                        ...
                        <div class="text-center py-4">
                            <h5 class="text-truncate"><?php echo $xml->content->name2; ?></h5>
                            <p class="m-0"><?php echo $xml->content->designation; ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 pb-2">
                    <div class="team-item bg-white mb-4">
                        ...
                        <div class="text-center py-4">
                            <h5 class="text-truncate"><?php echo $xml->content->name3; ?></h5>
                            <p class="m-0"><?php echo $xml->content->designation; ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 pb-2">
                    <div class="team-item bg-white mb-4">
                        ...
                        <div class="text-center py-4">
                            <h5 class="text-truncate"><?php echo $xml->content->name4; ?></h5>
                            <p class="m-0"><?php echo $xml->content->designation; ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 pb-2">
                    <div class="team-item bg-white mb-4">
                        ...
                        <div class="text-center py-4">
                            <h5 class="text-truncate"><?php echo $xml->content->name5; ?></h5>
                            <p class="m-0"><?php echo $xml->content->designation; ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 pb-2">
                    <div class="team-item bg-white mb-4">
                        ...
                        <div class="text-center py-4">
                            <h5 class="text-truncate"><?php echo $xml->content->name6; ?></h5>
                            <p class="m-0"><?php echo $xml->content->designation; ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 pb-2">
                    <div class="team-item bg-white mb-4">
                        ...
                        <div class="text-center py-4">
                            <h5 class="text-truncate"><?php echo $xml->content->name7; ?></h5>
                            <p class="m-0"><?php echo $xml->content->designation; ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 pb-2">
                    <div class="team-item bg-white mb-4">
                        ...
                        <div class="text-center py-4">
                            <h5 class="text-truncate"><?php echo $xml->content->name8; ?></h5>
                            <p class="m-0"><?php echo $xml->content->designation; ?>
                        </p>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid bg-dark text-white-50 py-5 px-sm-3 px-lg-5" style="margin-top: 90px;">
        <div class="row pt-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex flex-column justify-content-start">
                    <a class="text-white-50 mb-2" href="#"><i class="fa fa-angle-right mr-2"></i><?php echo $xml->content->footer->about; ?></a>
                    <a class="text-white-50 mb-2" href="#"><i class="fa fa-angle-right mr-2"></i><?php echo $xml->content->footer->designation; ?></a>
                    <a class="text-white-50 mb-2" href="#"><i class="fa fa-angle-right mr-2"></i><?php echo $xml->content->footer->services; ?></a>
                    <a class="text-white-50 mb-2" href="#"><i class="fa fa-angle-right mr-2"></i><?php echo $xml->content->footer->package; ?></a>
                    <a class="text-white-50 mb-2" href="#"><i class="fa fa-angle-right mr-2"></i><?php echo $xml->content->footer->guide; ?></a>
                    <a class="text-white-50 mb-2" href="#"><i class="fa fa-angle-right mr-2"></i><?php echo $xml->content->footer->testimonial; ?></a>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                <h5 class="text-white text-uppercase mb-4" style="letter-spacing: 5px;"><?php echo $xml->content->footer->contact; ?> Us</h5>
                ...
                <div class="w-100">
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-primary px-3"><?php echo $xml->content->sign->marindu; ?></button>
                        </div>
                    </div>
                </div>
            </div>
