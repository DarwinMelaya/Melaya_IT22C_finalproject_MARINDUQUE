...
<body>
    <?php
    $xml = simplexml_load_file('Melaya_IT2C_Marinduque/contact.xml');
    ?>
    <!-- Topbar Start -->
            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="contact.php" class="nav-item nav-link active"><?php echo $xml->content->contact; ?></a>
                    </div>
                </div>
            </nav>
        </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3 mb-md-0">
                                    <select class="custom-select px-4" style="height: 47px;">
                                        ...
                                        <option value="2"><?php echo $xml->content->option1; ?></option>
                                        <option value="3"><?php echo $xml->content->option1; ?></option>
                                        <option value="3"><?php echo $xml->content->option1; ?></option>
                                        <option value="3"><?php echo $xml->content->option1; ?></option>
                                        <option value="3"><?php echo $xml->content->option1; ?></option>
                                    </select>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="text-center mb-3 pb-3">
                <h6 class="text-primary text-uppercase" style="letter-spacing: 5px;"><?php echo $xml->content->contact; ?></h6>
                <h1><?php echo $xml->content->query; ?></h1>
            </div>
                    ...
                    <div class="contact-form bg-white" style="padding: 30px;">
                        ...
                        <form name="sentMessage" id="contactForm" novalidate="novalidate">
                            ...
                            <div class="text-center">
                                <button class="btn btn-primary py-3 px-4" type="submit" id="sendMessageButton"><?php echo $xml->content->send; ?></button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="row pt-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex flex-column justify-content-start">
                    ...
                    <a class="text-white-50 mb-2" href="#"><i class="fa fa-angle-right mr-2"></i><?php echo $xml->content->footer->services; ?></a>
                    <a class="text-white-50 mb-2" href="#"><i class="fa fa-angle-right mr-2"></i><?php echo $xml->content->footer->package; ?></a>
                    <a class="text-white-50 mb-2" href="#"><i class="fa fa-angle-right mr-2"></i><?php echo $xml->content->footer->guides; ?></a>
                    <a class="text-white-50 mb-2" href="#"><i class="fa fa-angle-right mr-2"></i><?php echo $xml->content->footer->testimonial; ?></a>
