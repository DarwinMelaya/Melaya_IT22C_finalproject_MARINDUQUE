...
<body>
    <?php
    $xml = simplexml_load_file('Melaya_IT2C_Marinduque/single.xml');
    ?>
    <!-- Topbar Start -->
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                ...
                                <div class="blog-date">
                                    <h6 class="font-weight-bold mb-n1"><?php echo $xml->content->date; ?></h6>
                                    <small class="text-white text-uppercase"><?php echo $xml->content->month; ?></small>
                                </div>
                            </div>
                        </div>
                        <div class="bg-white mb-3" style="padding: 30px;">
                            <div class="d-flex mb-3">
                                ...
                                <a class="text-primary text-uppercase text-decoration-none" href=""><?php echo $xml->content->tnt; ?></a>
                            </div><?php echo $xml->content->luzondatum; ?></h2>
                            <p><?php echo $xml->content->luzon; ?></p>
                            <p><?php echo $xml->content->datum; ?></p>
                            <h4 class="mb-3"><?php echo $xml->content->paradise; ?></h4>
                            <img class="img-fluid w-50 float-left mr-4 mb-2" src="img/blog-2.jpg">
                            <p><?php echo $xml->content->experience; ?></p>
                            <h5 class="mb-3"><?php echo $xml->content->spectacular; ?></h5>
                            <img class="img-fluid w-50 float-right ml-4 mb-2" src="img/blog-3.jpg">
                            <p><?php echo $xml->content->elevate; ?></p>
                        </div>
                    </div>
                    <!-- Blog Detail End -->
                    ...
                    <div class="bg-white" style="padding: 30px; margin-bottom: 30px;">
                        <h4 class="text-uppercase mb-4" style="letter-spacing: 5px;"><?php echo $xml->content->comments; ?></h4>
                        <div class="media mb-4">
                            <img src="img/user.jpg" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
                            <div class="media-body">
                                <h6><a href=""><?php echo $xml->content->namecom; ?></a> <small><i><?php echo $xml->content->datecom; ?></i></small></h6>
                                <p><?php echo $xml->content->comment; ?></p>
                                <button class="btn btn-sm btn-outline-primary"><?php echo $xml->content->reply; ?></button>
                            </div>
                        </div>
                        <div class="media">
                            <img src="img/user.jpg" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
                            <div class="media-body">
                                <h6><a href=""><?php echo $xml->content->namecom1; ?></a> <small><i><?php echo $xml->content->datecom1; ?></i></small></h6>
                                <p><?php echo $xml->content->comment1; ?></p>
                                <button class="btn btn-sm btn-outline-primary"><?php echo $xml->content->reply; ?></button>
                                <div class="media mt-4">
                                    <img src="img/user.jpg" alt="Image" class="img-fluid mr-3 mt-1"
                                        style="width: 45px;">
                                    <div class="media-body">
                                        <h6><a href=""><?php echo $xml->content->namecom2; ?></a> <small><i><?php echo $xml->content->datecom2; ?></i></small></h6>
                                        <p><?php echo $xml->content->comment2; ?></p>
                                        <button class="btn btn-sm btn-outline-primary"><?php echo $xml->content->reply; ?></button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <!-- Comment Form Start -->
                    <div class="bg-white mb-3" style="padding: 30px;">
                        <h4 class="text-uppercase mb-4" style="letter-spacing: 5px;"><?php echo $xml->content->leavecom; ?></h4>
                        <form>
                            <div class="form-group">
                                <label for="name"><?php echo $xml->content->name; ?></label>
                                <input type="text" class="form-control" id="name">
                            </div>
                            <div class="form-group">
                                <label for="email"><?php echo $xml->content->emailcom; ?></label>
                                <input type="email" class="form-control" id="email">
                            </div>
                            <div class="form-group">
                                <label for="website"><?php echo $xml->content->website; ?></label>
                                <input type="url" class="form-control" id="website">
                            </div>
    
                            <div class="form-group">
                                <label for="message"><?php echo $xml->content->message; ?></label>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="d-flex flex-column text-center bg-white mb-5 py-5 px-4">
                        ...
                        <h3 class="text-primary mb-3"><?php echo $xml->content->name; ?></h3>
                        <p><?php echo $xml->content->info; ?></p>
                    ...
                    <!-- Category List -->
                    <div class="mb-5">
                        <h4 class="text-uppercase mb-4" style="letter-spacing: 5px;"><?php echo $xml->content->category; ?></h4>
                        <div class="bg-white" style="padding: 30px;">
                            <ul class="list-inline m-0">
                                <li class="mb-3 d-flex justify-content-between align-items-center">
                                    <a class="text-dark" href="#"><i class="fa fa-angle-right text-primary mr-2"></i><?php echo $xml->content->design; ?></a>
                                    <span class="badge badge-primary badge-pill"><?php echo $xml->content->number1; ?></span>
                                </li>
                                <li class="mb-3 d-flex justify-content-between align-items-center">
                                    <a class="text-dark" href="#"><i class="fa fa-angle-right text-primary mr-2"></i><?php echo $xml->content->development; ?></a>
                                    <span class="badge badge-primary badge-pill"><?php echo $xml->content->number2; ?></span>
                                </li>
                                <li class="mb-3 d-flex justify-content-between align-items-center">
                                    <a class="text-dark" href="#"><i
                                            class="fa fa-angle-right text-primary mr-2"></i><?php echo $xml->content->online; ?></a>
                                    <span class="badge badge-primary badge-pill"><?php echo $xml->content->number3; ?></span>
                                </li>
                                <li class="mb-3 d-flex justify-content-between align-items-center">
                                    <a class="text-dark" href="#"><i
                                            class="fa fa-angle-right text-primary mr-2"></i><?php echo $xml->content->keyword; ?></a>
                                    <span class="badge badge-primary badge-pill"><?php echo $xml->content->number4; ?></span>
                                </li>
                                <li class="d-flex justify-content-between align-items-center">
                                    <a class="text-dark" href="#"><i
                                            class="fa fa-angle-right text-primary mr-2"></i><?php echo $xml->content->email; ?></a>
                                    <span class="badge badge-primary badge-pill"><?php echo $xml->content->number5; ?></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <!-- Recent Post -->
                    <div class="mb-5">
                        <h4 class="text-uppercase mb-4" style="letter-spacing: 5px;"><?php echo $xml->content->recent; ?></h4>
                        <a class="d-flex align-items-center text-decoration-none bg-white mb-3" href="">
                            <img class="img-fluid" src="img/blog-100x100.jpg" alt="">
                            <div class="pl-3">
                                <h6 class="m-1"><?php echo $xml->content->recent1; ?></h6>
                                <small><?php echo $xml->content->date1; ?></small>
                            </div>
                        </a>
                        <a class="d-flex align-items-center text-decoration-none bg-white mb-3" href="">
                            <img class="img-fluid" src="img/blog-100x100.jpg" alt="">
                            <div class="pl-3">
                                <h6 class="m-1"><?php echo $xml->content->recent2; ?></h6>
                                <small><?php echo $xml->content->date2; ?></small>
                            </div>
                        </a>
                        <a class="d-flex align-items-center text-decoration-none bg-white mb-3" href="">
                            <img class="img-fluid" src="img/blog-100x100.jpg" alt="">
                            <div class="pl-3">
                                <h6 class="m-1"><?php echo $xml->content->recent3; ?></h6>
                                <small><?php echo $xml->content->date3; ?></small>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="d-flex flex-wrap m-n1">
                            <a href="" class="btn btn-light m-1"><?php echo $xml->content->design; ?></a>
                            <a href="" class="btn btn-light m-1"><?php echo $xml->content->development; ?></a>
                            <a href="" class="btn btn-light m-1"><?php echo $xml->content->marketing; ?></a>
                            <a href="" class="btn btn-light m-1"><?php echo $xml->content->seo; ?></a>
                            <a href="" class="btn btn-light m-1"><?php echo $xml->content->writing; ?></a>
                            <a href="" class="btn btn-light m-1"><?php echo $xml->content->consulting; ?></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid bg-dark text-white-50 py-5 px-sm-3 px-lg-5" style="margin-top: 90px;">
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                <a href="" class="navbar-brand">
                    <h1 class="text-primary"><span class="text-white"><?php echo $xml->content->footer->marindu; ?></span><?php echo $xml->content->span; ?></h1>
                </a>
