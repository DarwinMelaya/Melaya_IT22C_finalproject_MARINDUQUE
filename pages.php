...
<body>
    <?php
    $xml = simplexml_load_file('Melaya_IT2C_Marinduque/pages.xml');
    ?>
    <!-- Topbar Start -->
            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        <a href="blog.php" class="nav-item nav-link"><?php echo $xml->content->grid; ?></a>
                        <a href="single.php" class="nav-item nav-link"><?php echo $xml->content->detail; ?></a>
                        <a href="destination.php" class="nav-item nav-link"><?php echo $xml->content->destination; ?></a>
                        <a href="guide.php" class="nav-item nav-link"><?php echo $xml->content->guide; ?></a>
                        <a href="testimonial.php" class="nav-item nav-link"><?php echo $xml->content->testimonial; ?></a>
                    </div>
                </div>
            </nav>
        </div>
        ...
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                ...
                <div class="d-inline-flex text-white">
                    <p1 class="m-0 text-uppercase"><a class="text-white" href="index.php"><?php echo $xml->content->home; ?></a></p1>
                    <i class="fa fa-angle-double-right pt-1 px-3"><?php echo $xml->content->about1; ?></i>
                </div>
            </div>
        </div>
    </div>
